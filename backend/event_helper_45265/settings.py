"""
Django settings for event_helper_45265 project.
...
ROOT_URLCONF = 'event_helper_45265.urls'
...
WSGI_APPLICATION = 'event_helper_45265.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "event_helper_45265 API",
    "DESCRIPTION": "API documentation for event_helper_45265 App",
    "VERSION": "v1",
}
